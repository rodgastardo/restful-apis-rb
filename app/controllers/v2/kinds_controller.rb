module V2
  class KindsController < ApplicationController
    ...
    #http_basic_authenticate_with name: "rod", password: "secret"
    #include ActionController::HttpAuthentication::Digest::ControllerMethods
    #USERS = {"rod" => Digest::MD5.hexdigest(["rod", "Application", "secret"].join(":"))}
    ...
    private
      ...
      #def authenticate
        #authenticate_or_request_with_http_digest("Application") do |username|
          #USERS[username]
        #end
        #authenticate_orequest_with_http_token do |token, options|
